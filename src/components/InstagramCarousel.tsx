...
const InstagramCarousel = () => {
  ...
  // Fallback images if no CMS data available
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center">
            <div className="animate-pulse bg-muted rounded-lg h-64 w-full max-w-4xl"></div>
          </div>
        </div>
      </section>
    );
                  ...
                  <div className="relative aspect-square overflow-hidden rounded-lg group cursor-pointer">
                    {image.link_url ? (
                      ...
                      >
                        <img 
                          src={image.image_url}
                          alt={image.alt_text || `Instagram image ${image.id}`}
