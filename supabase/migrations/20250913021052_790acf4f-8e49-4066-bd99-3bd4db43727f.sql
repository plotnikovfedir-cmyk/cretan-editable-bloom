-- Expand location_type enum with new categories
...
ALTER TABLE locations ALTER COLUMN location_type TYPE location_type USING location_type::text::location_type;
